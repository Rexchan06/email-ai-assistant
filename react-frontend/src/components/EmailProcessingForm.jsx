...
import { CalendarToday, Category, TuneRounded, AutoAwesome, Assessment } from '@mui/icons-material'
...
function EmailProcessingForm() {
    ...
    return (
        <>
            <Card sx={{
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                    ...
                    <Box sx={{ mt: 5, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
                        ...
                        {/* New results button - only show when results exist */}
                        {results && (
                            <Button
                                variant="outlined"
                                size="large"
            ...
            <ResultsModal open={modalState} onClose={() => setModalState(false)} results={results}></ResultsModal>
        </>
    )
}
